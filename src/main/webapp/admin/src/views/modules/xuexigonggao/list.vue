		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"0px 0 0","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm">
				<el-row :style='{"minHeight":"100vh","padding":"34px 20px 140px","boxShadow":"0 2px 0px rgba(0,0,0,.1)","top":"94px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221203/1f4690773fd84e218e0ef7d69885ee30.png) no-repeat left top,url(http://codegen.caihongy.cn/20221203/1057db36d2aa4bd4b375aa0ccb752a40.png) repeat-x left top,#7ca065","display":"block","width":"240px","position":"fixed","right":"0","order":"1"}' >
					<div :style='{"flexWrap":"wrap","margin":"0 0px 10px","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#fff","textAlign":"left","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">学习标题</label>
						<el-input v-model="searchForm.xuexibiaoti" placeholder="学习标题" clearable></el-input>
					</div>
				...
				<el-row :style='{"width":"100%","padding":"0","margin":"20px 0 10px","background":"none","display":"flex"}'>
					<el-button :style='{"border":"0px dotted #a347ea","cursor":"pointer","padding":"0 8px","boxShadow":"4px 4px 0px rgba(0,0,0,.1)","margin":"0 10px 10px 0","color":"#7ca065","minWidth":"68px","outline":"none","borderRadius":"0px","background":"rgba(124,160,101,.2)","width":"auto","fontSize":"14px","height":"36px"}' v-if="isAuth('xuexigonggao','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0px dotted #df2543","cursor":"pointer","padding":"0 8px","boxShadow":"4px 4px 0px rgba(0,0,0,.1)","margin":"0 10px 10px 0","color":"#d67081","minWidth":"68px","outline":"none","borderRadius":"0px","background":"rgba(223,37,67,.2)","width":"auto","fontSize":"14px","height":"36px"}' v-if="isAuth('xuexigonggao','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' prop="xuexiwenjian" label="学习文件">
						<template slot-scope="scope">
							<el-button v-if="scope.row.xuexiwenjian" type="text" size="small" @click="download($base.url+scope.row.xuexiwenjian)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='false'  
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.xuexibiaoti!='' && this.searchForm.xuexibiaoti!=undefined){
            params['xuexibiaoti'] = '%' + this.searchForm.xuexibiaoti + '%'
          }
      this.$http({
