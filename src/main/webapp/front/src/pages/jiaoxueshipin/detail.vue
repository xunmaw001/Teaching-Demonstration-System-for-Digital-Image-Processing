...
<div>
	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"0px auto","position":"relative","background":"none"}'>
		...
		<video :style='{"border":"2px solid #a4d9b7","padding":"20px 20%","margin":"20px 0 0 0","outline":"none","borderRadius":"8px","background":"#fff","display":"block","width":"100%"}' :src="baseUrl +  detail.jiaoxueshipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
    ...
    methods: {
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'jiaoxueshipin', userid: localStorage.getItem('userid')}}).then(res => {
